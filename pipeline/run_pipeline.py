...
from pipeline.orchestration.dag import DAG, Task, DAGValidationError
...
def _log_pipeline_run(dag_id: str, results: dict, elapsed: float):
    ...
    import csv, os
    header = ["run_ts", "dag_id", "total_tasks", "succeeded", "failed", "elapsed_seconds"]
...
def main():
    ...
    parser.add_argument("--hour", type=int, default=2,
                        help="UTC hour for scheduled runs (default: 2)")
